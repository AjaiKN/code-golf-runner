...
To see the programming languages that are allowed, go to [TIO](https://tio.run/) and **deselect “Recreational”** at the top so that only the “Practical” languages are visible (or click below to see the list).



<details>
  <summary>Click to view a list of allowed languages</summary>
  <p><b>Note: it's possible that this list could be out of date.</b></p>
